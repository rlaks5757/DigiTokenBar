#!/bin/bash
# DigiTokenBar.app 번들 조립 + /Applications 설치
set -euo pipefail
cd "$(dirname "$0")/.."
...
# 디지몬 진화 데이터(EVOLUTION.md §6) — DigimonData 가 Bundle.main 에서 찾는다.
...
<plist version="1.0">
<dict>
    <key>CFBundleIdentifier</key><string>io.github.rlaks5757.digitokenbar</string>
...
cat > "$APP/Contents/Library/LaunchAgents/io.github.rlaks5757.digitokenbar.login.plist" <<AGENT
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0">
<dict>
    <key>Label</key><string>io.github.rlaks5757.digitokenbar.login</string>
