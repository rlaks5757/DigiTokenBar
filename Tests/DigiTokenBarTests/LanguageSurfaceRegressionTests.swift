...
final class LanguageSurfaceRegressionTests: XCTestCase {
    ...
    func testVisibleCopyAndSettingsControlsAreRoutedToLocalization() throws {
        ...
        let settings = try String(contentsOf: root.appendingPathComponent("Sources/DigiTokenBar/UI/SettingsView.swift"), encoding: .utf8)
        ...
        let popover = try String(contentsOf: root.appendingPathComponent("Sources/DigiTokenBar/UI/PopoverView.swift"), encoding: .utf8)
